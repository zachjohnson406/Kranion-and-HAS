function [] = stepimgWithPressure(img1,img2,orientation)
    ...
    while j <= nz
        ...
        alphaData = ones(size(img2(:,:,j))) * 0.5; % Initialize transparency data
        ...
        %ylabel(cb1, 'kPa', 'Interpreter', 'latex', 'FontSize', 16);
        jlast = j;
