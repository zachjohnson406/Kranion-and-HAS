...
function [Q_rel,pressar,temps] = FUSF_HAS_Prep_loop_adj_atten(KRXfile,KRXpath,atten)
...
for i = 1:6
    ...
    %%CSF paper values with thalamus given gray matter values
    pHAS.a = [0,     0.068,  0.044,  0.21,    0.068,  .54553,    .47,  0.069, 0.0671, 0.068];   
    pHAS.a_abs = [0, 0.012,  0.044,  0.21,    0.012,  .54553,    .47, 0.012, 0.0671,  0.012];
    pHAS.c(6) = atten;
...
save(['maxTempsSimulationBoneSOS=',num2str(pHAS.c(6)),'.mat'],'maxTempsSimulation');
